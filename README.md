...
$ mkdir *MyDir* <br/>
$ cd *MyDir* <br/>
$ wget https://github.com/Qengineering/Hand-Pose-ncnn-Raspberry-Pi-4/archive/refs/heads/main.zip <br/>
...
## Running the app.
To run the application load the project file NanoDetHand.cbp in Code::Blocks.<br/> 
...
https://github.com/FeiGeChuanShu<br/><br/>
